...
public final class SBox {
    private static final int[][] forwardSBox = {
    ...
    private static final int[][] reverseSBox = {
     ...
     */
    protected static int performSubstitution(int number, char mode) {
