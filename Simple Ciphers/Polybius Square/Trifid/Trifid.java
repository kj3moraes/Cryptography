...
class Trifid extends Polybius {
    public static void main(String[] args) {
        ...
        switch (choice) {
            ...
            case '1':
                ...
                key = generateCustomKey(key.replaceAll(" ", ""), "ABCDEFGHIJKLMNOPQRSTUVWXYZ") + "+";
     ...
     * groups and key for encryption. It outputs the encryption of the plaintext
     * using the Trifid encryption algorithm.
     * 
    ...
    /**
     * TRIFID - DECRYPT This function takes 3 - parameters - encrypted text, size of
     * the groups and key for encryption. It outputs the decryption of the cipher
     * text using the Trifid decryption algorithm.
     * 
    ...
    private static String decrypt(String encryptedText, int groupingSize, String key) {
        ...
        // S1 : CONVERT THE CIPHER TEXT LETTER INTO THE 3 COORDINATES GROUP WISE
        ...
        // S2 : USE THE COORDINATES TO EXTRACT THE LETTERS
    ...
    /**
     * TRIFID - GET TRIGRAM COORDINATES This function takes 2 parameters - character
     * and a key. It outputs the coordinates of the character in the key using the
     * Trigram scheme employed in the Trifid encryption algorithm. A requirement is
     * that the character must be located SOMEWHERE in the key
     *
